...
define("Schuhe", ["require", "exports", "Artikel"], function (require, exports, Artikel_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Schuhe extends Artikel_js_1.default {
...
define("modulVerwaltung", ["require", "exports", "Artikel", "Schuhe", "Verwaltung"], function (require, exports, Artikel_js_2, Schuhe_js_1, Verwaltung_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let artikel1 = new Artikel_js_2.default('Jeans', 'Asos Jeans', 139, 0);
    console.log(artikel1);
    let artikel2 = new Artikel_js_2.default('Pulli', 'Asos Pulli', 49, 39);
    console.log(artikel2);
    let artikel3 = new Schuhe_js_1.default('Schuhe', 'Nike Schuhe', 129, 0, 42, 'Nike');
    console.log(artikel3);
    let artikel4 = new Schuhe_js_1.default('Schuhe', 'Adidas Schuhe', 79, 0, 39, 'Adidas');
    console.log(artikel4);
    let verwaltung = new Verwaltung_js_1.default();
